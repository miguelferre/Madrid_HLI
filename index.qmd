...
```{r hli-mapa}
#| label: fig-hli
#| fig-cap: "Healthy Living Index por barrio. Aparecen rotulados los **5 barrios con mayor HLI** (verdes oscuros — Comillas, Abrantes, Pradolongo, Zofío, San Isidro) y los **5 con menor HLI** (rojos — Sol, Justicia, Universidad, Embajadores, Goya)."
#| echo: false
...
Cruzando los 131 barrios por cuadrantes (HLI por encima/debajo de la mediana, renta neta por encima/debajo de la mediana):

| | alto HLI | bajo HLI |
|---|---:|---:|
| **renta alta** | 30 barrios | 36 barrios |
| **renta baja** | 36 barrios | 29 barrios |

Algunos barrios concretos para anclar la lectura:

- **Renta alta · alto HLI:** Cuatro Caminos, Berruguete, Pacífico, Imperial.
- **Renta alta · bajo HLI:** Valdemarín, Recoletos, Fuentelarreina, El Viso, Castellana.
- **Renta baja · alto HLI:** Comillas, Abrantes, Pradolongo, Zofío, San Isidro.
- **Renta baja · bajo HLI:** El Cañaveral, Las Águilas, Aluche, San Cristóbal.
- **Caso extremo:** Sol — HLI 0,12, 123 fast food/km², 0 % cubierta verde, renta media.
...
::: {.callout-note}
**El caso opuesto: El Pardo.** Aparece como casi suspenso en regla 3 (3,1 %) pero brilla en regla 30 (65,8 %). La explicación está en cómo "ve" cada regla la realidad: la regla 3 se apoya en el **inventario municipal** del Ayto, que cataloga los árboles bajo gestión y mantenimiento explícitos —arbolado viario, jardines, parques históricos—. El Pardo es un parque **forestal y reserva real** cuya masa boscosa **no se inventaría árbol a árbol** (no es viable ni tendría sentido catalogar individualmente cientos de miles de pinos y encinas en una superficie de 18.700 ha). En cambio, ESA WorldCover mide la cubierta arbórea **directamente desde satélite** y sí captura ese bosque continuo. La regla 30 es por tanto el indicador correcto en zonas no urbanizadas; la regla 3 funciona bien en trama urbana densa. Lo mismo ocurre, en menor medida, en Casa de Campo y El Goloso.
:::
